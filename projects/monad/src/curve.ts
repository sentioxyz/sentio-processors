...
import { CurvePool, CurvePoolBoundContractView, CurvePoolProcessorTemplate } from './types/eth/curvepool.js'
...
const template = new CurvePoolProcessorTemplate().onTimeInterval(
  async (block, ctx) => {
