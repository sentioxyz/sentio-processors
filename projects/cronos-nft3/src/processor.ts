...
MintedexchangeProcessor.bind({ address: '0x40cBf9C75a46b147E0fd9aB47df5E064aE015f92', network: 25, startBlock: 7000000 })
  ...
  .onEventRoyaltyPayment(async (event: any, ctx: any) => {
    const collection = event.args.collection
    const tokenId = Number(event.args.tokenId)
