        ...
        SuiAddressProcessor.bind({
            ...
            try {
                ...
                for (let coin of Object.keys(COIN_MAP)) {
                    ...
                    ctx.meter.Gauge("totalBalanceForAddress").record(totalBalance, { env: "mainnet", address, coin, coin_symbol: COIN_MAP[coin] });
                    ctx.meter.Gauge("coinObjectCountForAddress").record(coinObjectCount, { env: "mainnet", address, coin, coin_symbol: COIN_MAP[coin] });
                }
