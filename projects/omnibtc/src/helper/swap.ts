...
export async function buildPoolInfo(
  ...
  let [symbol_a, symbol_b, decimal_a, decimal_b, pairName, type, fee_label] = [
    "",
    "",
    0,
    0,
...
export async function buildIDOPoolInfo(
  ctx: SuiContext | SuiObjectContext,
  pool: string
): Promise<poolInfo> {
  let [symbol_a, symbol_b, decimal_a, decimal_b, pairName, type] = [
    "",
    "",
    0,
    0,
...
export const getOrCreatIDOPool = async function (
  ctx: SuiContext | SuiObjectContext,
  pool: string
): Promise<poolInfo> {
