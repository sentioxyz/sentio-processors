...
import { whitelistTokens } from "@sentio/sdk/aptos/ext";
...
coin.bind()
  .onEntryTransfer((call, ctx) => {
    ...
    const info = whitelistTokens().get(call.type_arguments[0])
...
// NOTE: getChainQueryClient and aptosSQLQuery are no longer available in the SDK
// The SQL query functionality has been removed. If you need this functionality,
// please check the Sentio SDK documentation for the updated API.
