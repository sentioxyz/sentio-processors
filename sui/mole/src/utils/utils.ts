...
import { ClmmpoolsError, MathErrorCode } from './errors.js'
...
export class MathUtil {
  ...
  static toX64_Decimal(num: Decimal.Decimal): Decimal.Decimal {
    return num.mul(Decimal.Decimal.pow(2, 64))
  }

  static toX64(num: Decimal.Decimal): BN {
    return new BN(num.mul(Decimal.Decimal.pow(2, 64)).floor().toFixed())
  }

  static fromX64(num: BN): Decimal.Decimal {
    return new Decimal.Decimal(num.toString()).mul(Decimal.Decimal.pow(2, -64))
  }

  static fromX64_Decimal(num: Decimal.Decimal): Decimal.Decimal {
    return num.mul(Decimal.Decimal.pow(2, -64))
  }
