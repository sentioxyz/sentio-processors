...
import {
  FireflyV3PoolProcessor,
  getFireflyV3PoolContractOnContext,
} from "./types/eth/fireflyv3pool.js";
...
async function getPoolArgsFromChain(ctx: EthContext, poolAddress: string) {
  const poolContract = getFireflyV3PoolContractOnContext(ctx, poolAddress);
