...
import { KSTONE_ADDRESS, NETWORK } from "./config.js";
...
// kStone to stone is 1:1
// there is rkStone(0x5Bd8405170FF4B2654C14265Cf4E193059503E2e) holding 27 kStone

ERC20Processor.bind({
  network: NETWORK,
  address: KSTONE_ADDRESS,
})
