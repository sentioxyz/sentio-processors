...
import {
  RErc20DelegatorContext,
  RErc20DelegatorProcessor,
} from "./types/eth/rerc20delegator.js";
import {
...
RErc20DelegatorProcessor.bind({
  network: NETWORK,
  address: rSTONE_ADDRESS,
})
...
async function updateAll(ctx: RErc20DelegatorContext, triggerEvent: string) {
