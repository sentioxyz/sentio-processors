...
import { SwapPairContext, SwapPairProcessor } from "./types/eth/swappair.js";
...
async function updateAllForPool(ctx: SwapPairContext, triggerEvent: string) {
